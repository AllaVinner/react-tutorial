...
function PointPicker(props) {
    let setPoint1X = props.setPoint1X ? props.setMinPoint1X : () => 1;
    let setPoint1Y = props.setPoint1Y ? props.setPoint1Y : () => 1;
    let setPoint2X = props.setPoint2X ? props.setMinPoint2X : () => 1;
    ...
    let pointHeight = props.pointHeight ? props.pointHeight : 35
    let pointWidth = props.pointWidth ? props.pointWidth : 35
    ...
    return <div className="box-picker">
